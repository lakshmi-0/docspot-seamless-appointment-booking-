...
const UserHome = () => {
  ...
  const getUserData = async () => {
    try {
      await axios.post(
        'http://localhost:5001/api/user/getuserdata',
        {},
        {
          headers: {
      ...
      <div className="layout">
        <div className="sidebar">
          ...
          <div className="menu">
            ...
            <div
              className={`menu-items ${activeMenuItem === 'bookappointment' ? 'active' : ''}`}
              onClick={() => handleMenuItemClick('bookappointment')}
            >
              <CalendarMonthIcon className="icon" />
        ...
        <div className="content">
          ...
          <div className="body">
            ...
            {activeMenuItem === 'bookappointment' && <BookAppointment/>}
            {!['applyDoctor', 'notification', 'userappointments', 'bookappointment'].includes(activeMenuItem) && (
              <Container>
