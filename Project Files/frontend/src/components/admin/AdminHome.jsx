...
import CalendarTodayIcon from '@mui/icons-material/CalendarToday'; // Optional: for Appointments menu icon

const AdminHome = () => {
  const [userdata, setUserData] = useState({});
  const [activeMenuItem, setActiveMenuItem] = useState('adminappointments'); // ✅ default to appointments
